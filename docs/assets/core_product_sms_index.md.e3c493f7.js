...
<span class="line"></span></code></pre></div>`,4);function i(d,_,u,E,m,h){const a=t("Platform");return c(),p("div",null,[y,D,C,A,o(a,{browser:"",electron:"",server:"",scriptlet:""}),F])}const S=l(r,[["render",i]]);export{B as __pageData,S as default};
